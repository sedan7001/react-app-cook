    ...
    return (
        <div>
            ...
            <div className="ripple">
                <form name="ripple_form" method="post" action="insert_ripple.php?table=cook_free&amp;num=21">
                    <div className="ripple_box">
                        <div className="ripple_box1"><img src={titleComment} alt="titleComment"/></div>
                        <div className="ripple_box2"><textarea rows="5" cols="65" name="ripple_content"></textarea>
                        </div>
                        <div className="ripple_box3"><a><img src={commentSubmitBtn}
                                                             onClick="check_input()" alt="commentSubmitBtn"/></a></div>
                    </div>
                </form>
            </div>
            <div className="viewButton">
                ...
                <button className="smallButton"><a>삭제</a>
                </button>
